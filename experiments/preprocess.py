...
from scripts.feature.get_feature import SalesMultipliedSellPriceDevideSellPrice
...
if __name__ == "__main__":
    ...
    luigi.build([GetTrain(), GetValid(), GetTest()], local_scheduler=True)
    # luigi.build([SalesMultipliedSellPriceDevideSellPrice()], local_scheduler=True)
